...
LeftValveTimeJackpot  = JackpotFactor*GetValveTimes(TrialData.RewardMagnitude(1, iTrial), LeftPort);
RightValveTimeJackpot  = JackpotFactor*GetValveTimes(TrialData.RewardMagnitude(2, iTrial), RightPort);
...
sma = AddState(sma, 'Name', 'wait_Sin',...
    'Timer',TaskParameters.GUI.ChoiceDeadline,...
    'StateChangeConditions', {LeftPortIn,'wait_L_start',RightPortIn,'wait_R_start','Tup','IncorrectChoice'},...
    'OutputActions',{LeftLight,LeftLightValue,RightLight,RightLightValue});
