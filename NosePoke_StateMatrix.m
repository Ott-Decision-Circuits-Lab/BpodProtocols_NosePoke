...
sma = AddState(sma, 'Name', 'WaterCIn',...
        'Timer', CenterValveTime,...
        'StateChangeConditions', {'Tup', 'CenterDrinking'},...
        'OutputActions', {'ValveState', CenterValve});

sma = AddState(sma, 'Name', 'CenterDrinking',... % by passing dummy state StillSampling -> no trigger GlobalTimer2
    'Timer', 0,...
    'StateChangeConditions', {CenterPortOut, 'WaitSIn'},...
    'OutputActions', {});
